...
public class newSwap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Jungle hust.soict.hedspi.aims.media.DigitalVideoDisc title: " + jungleDigitalVideoDisc.getTitle());
        System.out.println("Cinderella hust.soict.hedspi.aims.media.DigitalVideoDisc title: " + cinderellaDigitalVideoDisc.getTitle());
